            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RangeValidator ControlToValidate="edadTxt" CssClass="text-danger" ID="RangeValidator1" runat="server" ErrorMessage="Debe Ingresar Edad Valida" MinimumValue="18" MaximumValue="99" Type="Integer"></asp:RangeValidator>
                        </div>
                    <div class="form-group">
